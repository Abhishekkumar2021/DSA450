...
Hint:
1.  If you have n distinct integers, how many maximum heaps can be made from them?
2.  If you know the answer for n integers, how to build answer for n + 1 integers?
3.  You can use the above recurrence relation to build the answer.
